/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=stage --env-interface=BaseEnv` (hash: 2a83bc1b2ebeea9588fa80fa419cd8bb)
// Runtime types generated with workerd@1.20260801.1 2025-06-17 nodejs_compat
interface __BaseEnv_BaseEnv {
	CACHE: KVNamespace;
	BUCKET: R2Bucket;
	DB: D1Database;
	QUEUE: Queue;
	VIRTUAL_BROWSER: BrowserRun;
	AI: Ai;
	EVALUATION_SCHEDULER_OBJECT: DurableObjectNamespace<import("./src/index").EvaluationSchedulerObject>;
	LINK_CLICK_TRACKER_OBJECT: DurableObjectNamespace<import("./src/index").LinkClickTrackerObject>;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "EvaluationSchedulerObject" | "LinkClickTrackerObject";
	}
